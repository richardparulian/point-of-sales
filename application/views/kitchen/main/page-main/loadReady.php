                                    ...
                                    <form id="check" method="post">
                                        <table class="w-full text-xs">
                                            <tbody>
                                                <?php foreach ($value['Menu'] as $items) : ?>
                                                    <tr>
                                                        <td class="py-1 px-2 text-sm text-center"><?= $items['Qty']; ?></td>
                                                        <td class="py-1 text-sm text-left">
                                                            <span><?= $items['MenuName']; ?></span>
                                                            <br>
                                                            <small><?= $items['NoteDetail']; ?></small>
                                                        </td>
                                                        <td class=" px-2 text-sm text-center align-middle">
                                                    ...
                                                    <?php foreach ($items['Parent'] as $key) : ?>
                                                        <tr>
                                                            <td class="py-1 px-2 text-sm text-center"><?= $key['Qty']; ?></td>
                                                            <td class="py-1 text-sm text-left">
                                                            ...
                                                            <td class=" px-2 text-sm text-center align-middle">
                                                                <?php if ($key['StatusTransactionDetail'] == 1) : ?>
                                                                    <input checked onclick="return false;" id="checked-checkbox" type="checkbox" class="items w-4 h-4 text-black bg-gray-100 rounded border-gray-300 focus:ring-black">
                                                                <?php else : ?>
                                                                    <input id="default-checkbox" data-id="<?= $key['TransactionDetailID']; ?>" name="status_td" type="checkbox" value="1" class="items w-4 h-4 text-black bg-gray-100 rounded border-gray-300 focus:ring-black">
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
